      ...
      {!submitted ? (
        <form onSubmit={handleForgotPassword} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-white/[0.02] border border-white/5 focus:border-cyan-500/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-cyan-500/10 focus:bg-white/[0.04] text-sm text-slate-200 placeholder-slate-600 transition-all font-semibold"
                value={email}
          ...
          <motion.button 
            ...
            type="submit" 
            disabled={loading} 
            className="w-full bg-gradient-to-r from-cyan-600 via-indigo-650 to-blue-650 hover:from-cyan-500 hover:via-indigo-550 hover:to-blue-500 text-white py-3.5 rounded-2xl font-extrabold shadow-lg shadow-cyan-500/15 hover:shadow-xl active:scale-[0.98] transition-all flex justify-center items-center text-[10px] uppercase tracking-widest font-black"
          >
