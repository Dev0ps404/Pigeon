  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-[#0052a3] tracking-tight mb-2">Welcome Back</h1>
        <p className="text-gray-500 text-sm">Login to continue your flight</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div>
          ...
          <div className="flex justify-end mt-2.5">
            <Link to="/forgot-password" className="text-xs font-semibold text-[#0066cc] hover:text-[#0052a3] hover:underline transition-colors">
              Forgot Password?
            </Link>
          </div>
        </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <button 
          ...
          className="w-full max-w-[320px] mx-auto flex items-center justify-center gap-2.5 py-2.5 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 active:scale-[0.98] transition-all font-semibold text-gray-700 text-sm shadow-sm"
        >
      ...
      <p className="text-center text-xs text-gray-500 font-medium">
        Don't have an account? <Link to="/register" className="text-[#0066cc] font-bold hover:underline">Sign up</Link>
      </p>
    </motion.div>
  );
};
