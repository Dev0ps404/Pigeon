  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3.5 mb-6">
        <div className="flex justify-center w-full col-span-1"><GoogleLogin onSuccess={handleGoogleSuccess} onError={() => toast.error('Google Login Failed')} theme="outline" text="continue_with" /></div>
        <button 
          type="button"
