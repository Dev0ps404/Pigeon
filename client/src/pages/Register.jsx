  ...
  return (
    ...
    >
      <div className="text-center mb-8 relative z-10">
        <h1 className="text-3xl font-extrabold text-[#0052a3] dark:text-[#38bdf8] tracking-tight mb-2">Create Account</h1>
        <p className="text-gray-500 dark:text-slate-400 text-sm font-medium">Sign up to start your flight</p>
      </div>

      <form onSubmit={handleRegister} className="space-y-4 relative z-10">
        {/* Username Field */}
        <div>
          <label className="text-xs font-bold text-gray-500 dark:text-slate-400 mb-1.5 block text-left pl-1 uppercase tracking-wider">
            Username
          </label>
        ...
        <button 
          type="submit" 
          disabled={loading} 
          className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3.5 rounded-xl font-bold shadow-lg shadow-blue-500/10 hover:shadow-xl active:scale-[0.98] transition-all flex justify-center items-center text-sm tracking-wide mt-2"
        >
      ...
      <p className="text-center text-xs text-gray-500 dark:text-slate-400 font-semibold relative z-10">
        Already have an account? <Link to="/login" className="text-[#0066cc] dark:text-[#38bdf8] font-black hover:underline ml-1">Sign in</Link>
      </p>
    </motion.div>
  );
};
