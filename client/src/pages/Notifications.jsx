  ...
  return (
    <div className="flex-1 flex h-full bg-[#f3f4f6] dark:bg-[#030712] overflow-hidden rounded-tl-[2.5rem] shadow-[-10px_0_30px_rgba(0,0,0,0.05)] border-t border-l border-white/50 dark:border-white/5 relative z-10">
        ...
        <div className="flex-1 overflow-y-auto space-y-3 custom-scrollbar">
          {loading ? (
            ...
            <div className="text-center py-12 text-gray-400">
              <FiInbox size={36} className="mx-auto mb-2 opacity-40 animate-pulse" />
              <p className="text-sm">Inbox is completely clear</p>
              <p className="text-xs opacity-65 mt-1">We'll alert you when something happens.</p>
            </div>
          ) : (
            <AnimatePresence>
      ...
      <div className="flex-1 hidden md:flex flex-col items-center justify-center bg-gray-50/30 dark:bg-[#0a0f1c]">
        ...
        <h3 className="text-xl font-bold text-gray-800 dark:text-white">Active Alerts & Activity</h3>
        <p className="text-gray-500 text-sm max-w-xs text-center mt-2">Stay up to date with core notifications, incoming calls, mentions, and friend activity feeds instantly.</p>
      </div>
