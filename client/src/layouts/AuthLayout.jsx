...
const AuthLayout = () => {
  return (
    <div
      className="min-h-screen w-full bg-[#0b1020] text-slate-900 relative overflow-hidden flex items-center justify-center p-6 md:p-10"
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-[#0b1020] via-[#0d1426] to-[#0a0f1c] opacity-90" />

      <div className="relative z-10 w-full max-w-6xl bg-white/90 rounded-[36px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.35)] border border-white/10">
