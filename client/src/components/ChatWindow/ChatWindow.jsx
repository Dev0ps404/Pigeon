...
const ChatWindow = ({ isTyping }) => {
  ...
  return (
    ...
    >
      ...
      {isDragging && (
        <div 
          className="absolute inset-0 bg-blue-500/10 backdrop-blur-[2px] border border-dashed border-blue-500/30 rounded-3xl m-4 flex flex-col items-center justify-center z-50 pointer-events-none m-6"
        >
          <motion.div 
          ...
          >
            ...
            <p className="font-bold text-white">Drop your file here to attach</p>
            <p className="text-xs text-gray-500">Supports images, videos, audio, and documents</p>
          </motion.div>
        </div>
      )}
      ...
      <div className="h-20 border-b border-white/5 px-4 md:px-8 flex items-center justify-between bg-[#111827]/40 dark:bg-[#0c1226]/40 backdrop-blur-md sticky top-0 z-20 shadow-sm select-none">
        <div className="flex items-center gap-2 md:gap-4 min-w-0">
          ...
          >
            <div className="relative shrink-0">
              {chatPic ? (
                <img referrerPolicy="no-referrer" src={chatPic} alt="avatar" className="w-11 h-11 md:w-12 md:h-12 rounded-full object-cover shadow-md border border-white/10" />
              ) : (
        ...
        <div className="flex items-center gap-1 md:gap-2 shrink-0">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-xl text-gray-400 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/5 transition-all" title="More Options">
            ...
            {isRecording ? (
              <div className="flex-1 bg-red-950/20 rounded-2xl flex items-center px-4 py-2 border border-red-900/30 justify-between animate-pulse">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-red-400 uppercase tracking-widest">Recording Note</span>
